        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <button
              ...
              aria-pressed={isDark}
              aria-label={
                isDark ? t("aria.switch_to_light") : t("aria.switch_to_dark")
              }
              title={isDark ? t("title.light_mode") : t("title.dark_mode")}
  ...
  return (
    <select
      ...
      onChange={(e: React.ChangeEvent<HTMLSelectElement>) =>
        setLocale(e.target.value as "en" | "hu" | "ro")
      }
      aria-label="Select language"
      className="hidden sm:inline-block border border-[color:var(--border)] rounded px-2 py-1 text-sm bg-[color:var(--background)]"
    >
